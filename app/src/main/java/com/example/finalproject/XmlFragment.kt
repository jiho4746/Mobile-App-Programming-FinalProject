...
class XmlFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val call: Call<responseInfo> = MyApplication.networkServiceXml.getXmlList(
            "dO8dPl5qXVCtvv7vRwZiN5u1PWygzNeBq3eeGaxdM3NFokJX9cLruVuBH1JPFo9dC0fcFUe/YDe4huqNW5M7/w==",10, 1)
        call?.enqueue(object : Callback<responseInfo> {
            override fun onResponse(call: Call<responseInfo>, response: Response<responseInfo>) {
                if(response.isSuccessful){
                    ...
                    binding.XmlRecyclerView.adapter = XmlAdapter(activity as Context, response.body()!!.body!!.data!!.list)
                }
            }
